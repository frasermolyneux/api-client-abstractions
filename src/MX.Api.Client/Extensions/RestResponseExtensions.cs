...
public static class RestResponseExtensions
{
    ...
    public static ApiResult ToApiResult(this RestResponse response)
    {
        ...
        if (string.IsNullOrWhiteSpace(response.Content))
        {
            ...
            {
                Errors = [new ApiError("NullContent", NullContentError)]
            };
        ...
        try
        {
            ...
            if (apiResponse is null)
            {
                ...
                if (dynamicObj != null)
                {
                    ...
                    {
                        Errors = [new ApiError("DeserializationError", DeserializationError)]
                    };
        ...
        catch (JsonException ex)
        {
            var errorResponse = new ApiResponse
            {
                Errors = [new ApiError("JsonError", $"JSON deserialization error: {ex.Message}")]
            };
            httpResponse.Result = errorResponse;
            return httpResponse;
        }
        catch (Exception ex)
        {
            var errorResponse = new ApiResponse
            {
                Errors = [new ApiError("UnexpectedError", $"Unexpected error during response processing: {ex.Message}")]
            };
            httpResponse.Result = errorResponse;
            return httpResponse;
        }
